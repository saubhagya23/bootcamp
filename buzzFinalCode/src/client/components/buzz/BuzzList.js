...
class BuzzList extends Component{
    ...
    render(){
        ...
        var userImg = this.props.sessionCreate.sessionData.userImage;

        var buzzText = this.props.buzzCreate.buzzData;

        var buzzTime = moment(buzzText.createdAt).format('MMMM Do YYYY, h:mm:ss a');
